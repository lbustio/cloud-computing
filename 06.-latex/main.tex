...
\item Explicación de los temas.
\item Presentación de la plataforma a emplear en el curso.
\end{itemize}
&
\textbf{Práctica}
\begin{itemize}
...
2 & 15/05 &
\textbf{ICloud Computing con GCP}
\begin{itemize}
...
\item Almacenamiento cloud como actividad posterior.
\end{itemize}
&
\textbf{Práctica}
\begin{itemize}
...
\item Entregar reporte con evidencias, diagrama, costos, riesgos, troubleshooting y reflexion.
\end{itemize}
\\
\hline
3  & 18/05 & & \\
