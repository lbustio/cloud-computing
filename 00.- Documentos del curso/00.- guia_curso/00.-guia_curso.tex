...
\hline
3  & 18/05 &
\textbf{Pipelines de observabilidad con ELK Stack}
\begin{itemize}
...
\begin{itemize}
\item Revisar el material de la carpeta \texttt{02.- ELK Stack}.
...
\item Preparar dudas tecnicas para la instalacion de la sesion 4.
\item Sin tarea entregable en esta sesion.
\end{itemize}
\\
\hline
4  & 22/05 &
\textbf{Instalacion de ELK Stack}
\begin{itemize}
...
\item Dejar la VM preparada para la implementacion de la sesion 5.
\end{itemize}
\\
\hline
5  & 25/05 &
\textbf{Implementacion de ELK Stack}
\begin{itemize}
...
\item Entregar reporte con arquitectura, dataset, consultas, dashboard, problemas encontrados, soluciones y evidencias.
\end{itemize}
\\
\hline
6  & 29/05 & & \\
