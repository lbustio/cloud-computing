...
12 & 15/06 & \textbf{Clase practica: Deteccion de APKs maliciosas mediante permisos de Android}
  \begin{itemize}
    ...
    \item Analisis exploratorio: distribucion de clases, permisos por APK, permisos frecuentes, diferenciales y sensibles.
    \item Mineria de itemsets frecuentes (Apriori), reglas de asociacion y contraste estadistico de hipotesis.
    \item Agrupamiento no supervisado (K-Means) y modelos supervisados (Regresion Logistica, Random Forest, Extra Trees).
    \item Evaluacion: accuracy, recall, F1, ROC-AUC, validacion cruzada e importancia de caracteristicas.
    \item Guardado del modelo y analisis de APKs reales con la aplicacion web Flask.
  \end{itemize}
&
\textbf{Tarea}
  \begin{itemize}
